...
var StyledButton$2 = /*#__PURE__*/styled$1(function (_ref) {
	...
	return React.createElement('a', _extends({ href: href, rel: 'nofollow noopener' }, props));
}, {
	displayName: 'Button',
...
var MessageButton = function (_React$Component) {
	...
	MessageButton.prototype.render = function render() {
		return React.createElement(StyledButton$1, _extends({}, this.props, { onClick: this.handleClick }));
	};
...
var Image = function Image(_ref) {
	...
	return React.createElement(
		...
		React.createElement(
			...
			null,
			React.createElement(StyledImg, _extends({ alt: '' }, getThumbnailProps(url, srcset)))
		)
	);
};
...
var Carousel = function (_React$PureComponent) {
	...
	function Carousel() {
		...
		}, _this.handleContainerScroll = dataUtils.throttle(200, _this.showAppropriateArrowsIfNeeded), _this.scrollToDirection = dataUtils.memoize(function (direction) {
			return function (event) {
				event.stopPropagation();
