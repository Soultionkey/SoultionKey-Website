        ...
        return (
            <div>
                ...
                <div className="div-test"></div>
                    <div id="bg-ecommerce-hero" >
                    <div >
                    <pre className="ecommerce-overlay-div">{`
 We design & develop custom websites 
 upon proven digital marketing 
 strategies .
          `}</pre>                     
                    </div>
                    <Button  style={{  backgroundColor: 'gray' }} className="ecommerce-bg-button" onClick={this.toggle}><span className="ecommerce-bg-button-text ">Schedule a Free Consultation</span></Button>
                      <img src={playIcon}
                                alt="animated"
                                className="ecommerce-playIcon "
                                onClick={this.openModal}
                            />
                    
                    </div>
                    <div className="ecommerce-home-serperator">
                        <div className="ecommerce-home-section">
                            <h1 className="pricing-text"><strong><br /><br />Web Services Pricing </strong></h1>
                            <hr className="ecommerce-spirating-line" />
                            {!this.state.loading ?
                                <Spinner />
                                :

                                <div className="ecommerce-pricing-row">
                                    <div className="ecommerce-pricing-column">
                                        <div className="ecommerce-pricing-card " style={{ backgroundColor: '#CD7F32' }}>
                                    ...
                                    <div className="ecommerce-pricing-column ">
                                        <div className="ecommerce-pricing-card " style={{ backgroundColor: 'silver' }}>
                                    ...
                                    <div className="ecommerce-pricing-column">
                                        <div className="ecommerce-pricing-card" style={{ backgroundColor: 'goldenrod' }}>
                                    ...
                                    <div className="ecommerce-pricing-column">
                                        <div className="ecommerce-pricing-card" style={{ backgroundColor: '#E5E4E2' }}>
