        ...
        return (
            <div>
                ...
                <div className="div-test"></div>
                    <div id="bg-seo-hero" >
                    <div >
                      <pre className="seo-overlay-div">{`
 We design & develop custom websites 
 upon proven digital marketing 
 strategies .
          `}</pre>
                    </div>
                    <Button  style={{  backgroundColor: 'gray' }} className="seo-bg-button" onClick={this.toggle}><span className="seo-bg-button-text ">Schedule a Free Consultation</span></Button>
                      <img src={playIcon}
                                alt="animated"
                                className="seo-playIcon "
