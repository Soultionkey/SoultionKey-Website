...
class HomeContent extends Component {
    constructor(props) {
        ...
        this.mobilePage = this.mobilePage.bind(this);
        this.seoPage = this.seoPage.bind(this)
    }
                        ...
                        <div className="home-serperator">
                            <div className="home-section">
                                <div className="rowHome">
                                    <div className="home-column round-button-web" onClick={this.webPage}>
                                    ...
                                    <div className="home-column">
                                        <div className="home-card round-button-digital" onClick={this.seoPage} >
                                        </div>
                                        <div className="round-services-text">
                                            <h5>SEO</h5>
